...
問い合わせ内容を入力し、回答トーン（丁寧/標準/簡潔）を選択して回答候補を生成します。

![問い合わせ入力画面](docs/images/query-page.png)

テキスト入力後、「回答候補を生成」ボタンで回答を取得できます。

![問い合わせ入力済み](docs/images/query-page-input.png)

### 管理画面

FAQ・利用規約・マニュアル・過去問い合わせのアップロード・削除ができます。

![管理画面](docs/images/admin-page.png)
